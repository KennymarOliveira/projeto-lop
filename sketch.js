...
function preload() {
  imgDocente = loadImage("/Imagens/docente.png");
  imgProgramador = loadImage("/Imagens/programador.png");
  imgEspantalho = loadImage("/Imagens/espantalho.png");
  imgPilha = loadImage("/Imagens/pilha.png");
  imgToalha = loadImage("/Imagens/toalha.png");
  imgMilho = loadImage("/Imagens/milho.png");
  imgGalinha = loadImage("/Imagens/galinha.png");
  imgMontanha = loadImage("/Imagens/montanha.png");
  imgDinheiro = loadImage("/Imagens/dinheiro.png");
  imgGolfinho = loadImage("/Imagens/golfinho.png");
  imgChocolate = loadImage("/Imagens/chocolate.png");
  imgMochila = loadImage("/Imagens/mochila.png");
  imgCachorro = loadImage("/Imagens/cachorro.png");
  imgChapeu = loadImage("/Imagens/chapeu.png");
  imgFundo = loadImage("/Imagens/fundo.png");
  imgVida = loadImage("/Imagens/vida.png");
  imgAbelha = loadImage("/Imagens/abelha.png");
  imgAgulha = loadImage("/Imagens/agulha.png");
  imgAranha = loadImage("/Imagens/aranha.png");
  imgBanheira = loadImage("/Imagens/banheira.png");
  imgCachimbo = loadImage("/Imagens/cachimbo.png");
  imgCachoeira = loadImage("/Imagens/cachoeira.png");
  imgCaminhao = loadImage("/Imagens/caminhao.png");
  imgCegonha = loadImage("/Imagens/cegonha.png");
  imgChave = loadImage("/Imagens/chave.png");
  imgChinelo = loadImage("/Imagens/chinelo.png");
  imgChuveiro = loadImage("/Imagens/chuveiro.png");
  imgCoelho = loadImage("/Imagens/coelho.png");
  imgConcha = loadImage("/Imagens/concha.png");
  imgCozinheira = loadImage("/Imagens/cozinheira.png");
  imgFolha = loadImage("/Imagens/folha.png");
  imgIlha = loadImage("/Imagens/ilha.png");
  imgJoaninha = loadImage("/Imagens/joaninha.png");
  imgMachado = loadImage("/Imagens/machado.png");
  imgMinhoca = loadImage("/Imagens/minhoca.png");
  imgNinho = loadImage("/Imagens/ninho.png");
  imgOlho = loadImage("/Imagens/olho.png");
  imgOvelha = loadImage("/Imagens/ovelha.png");
  imgPalhaço = loadImage("/Imagens/palhaço.png");
  imgSanduiche = loadImage("/Imagens/sanduiche.png");
  soundFormats('mp3', "ogg");
  somDeFundo = loadSound("/Sons/fundo.mp3", som);
}
